...
public class Classement extends AbstractTableModel{
	...
	{	
		ListIterator<Joueur> iterJoueur = l.listeJoueur.listIterator(); // Iterateur de la liste
		String pseudo = null; // pseudo vaut null
		int score = 0; // score à 0
		Joueur j = new Joueur(); // creation nouveau joueur
		
		// Pour i allant de 0 à indice de la ligne
		for(int i = 0; i <= idL; i++)
		{
