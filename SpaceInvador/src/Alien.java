...
// Cette classe permet de creer un Alien avec ses methodes associees
public class Alien extends Rectangle2D.Double
{
	...
	public Alien(int x, int level)
	{
		...
		// La robustesse est représentee par l'epaisseur du contour
		// Chaque alien possede sa propre robustesse
